...
\[\implies\boxed{i_L(t)=[5.2e^{-1000t}\cos(7000t-15.945^\circ)]u(t)}\]
...
\[\boxed{I(s)=\frac{\dfrac{50s+40}{s(s+1)}}{1+0.4s+\dfrac{s+1.8}{s+1}}=\frac{125s+100}{s(s^2+6s+7)}}\]
...
\[\boxed{V_o=\frac{12500}sI+\frac{150}s=\frac{150s^2+203125s+214843750}{s(s^2+1250s+781250)}}\]
...
\[\implies \boxed{v_o(t)=[2755+160.08{e^{-625t}}\cos(625t+141.34^\circ)]u(t)\text{ V}}\]
\end{enumerate}
...
\[\implies\boxed{i_L(t)=[0.5e^{-80000t}\cos(60000t-16.26^\circ)]u(t)\text{ A}}\]
...
\[\boxed{\begin{array}{rl}V_o&=\dfrac{325}s-\dfrac{325}{s+1000}\\[1em]I_o&=\dfrac{0.52}s-\dfrac{0.52}{s+1000}\end{array}}\]
...
$\boxed{V_1=-25I=\dfrac{9000000}{(s+10000)^2}}$
...
\[\boxed{V_2=\frac{900000}{(s+10000)^2}+\frac{90}{s+10000}}\]
...
\item From KVL,
\[-\frac{20}s+50000I_1+\frac{5\cdot10^6I_1}s=0\implies \boxed{I_1=\frac{20}{5000000+50000s}=\frac{0.4\cdot10^{-3}}{s+100}}\]
\[\boxed{V_1=\frac{10}3\cdot\frac{10^6}s\cdot I=\frac{4000/3}{s(s+100)},\quad V_2=\frac{10^7}{6s}\cdot I=\frac{2000/3}{s(s+100)}}\]
...
\item $\boxed{\frac{V_m(L\omega\cos\phi-R\sin\phi)}{\omega^2L^2+R^2}e^{-\frac RLt}}$

\item $\boxed{\frac{V_m\sin[\omega t+\phi-\theta(\omega)]}{\sqrt{\omega^2L^2+R^2}}}$

\item $\mathbf{V}_g=\mathbf{I}(j\omega L+R)\implies\mathbf{I}=\dfrac{V_m\phase{\phi-90^\circ}}{\sqrt{\omega^2L^2+R^2}\phase{\theta(\omega)}}$
\[\implies\boxed{\Re(\mathbf{I})=\frac{V_m}{\sqrt{\omega^2L^2+R^2}}\sin[\omega t+\phi-\theta(\omega)]}\]
...
\[\implies \boxed{V_o=V_o'+V_o''=\frac{320000(s+320)}{s(s^2+1000s+240000)}}\]
