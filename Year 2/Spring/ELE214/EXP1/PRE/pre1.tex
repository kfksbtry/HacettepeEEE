...
\begin{figure}[H]
    ...
    \textit{Graphs 6 and 7: The voltage across and the current through the resistor in Circuit 6}
\end{figure}
...
\begin{figure}[H]
    ...
    \textit{Graph 8: Circuit 7 for one period}
...
\begin{figure}[H]
    ...
    \textit{Graph 9: Circuit 8 for one period}
...
\begin{figure}[H]
    ...
    \textit{Graph 10: Circuit 9 for one period}
...
\begin{figure}[H]
    ...
    \textit{Graph 11: Circuit 10 for four periods}
