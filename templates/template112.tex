...
\fancyhf{} %% Removes the page numbers.
...
%%------------------------------------%%
[description] e.g.: {\textit{This part of the experiment is prepared with Online LaTeX Editor Overleaf, and the circuits are drawn in LTspice. Visit the website for the code here:}} %% May omit the circuit part or insert anything else in the preamble.
...
{\textbf{[NUM].[num]} \lipsum[1]} %% Edit the text.
...
\begin{tikzpicture}
\begin{axis}[
title={Graph 3: The relation between $I_{\text{in}}$ and $I_2$},
width=8cm,
xlabel={$I_{\text{in}}$ (mA)},
ylabel={$I_2$ (mA)},
xmin=4, xmax=28,
